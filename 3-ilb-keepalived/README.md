...
This document provides instructions on how to deploy the example implementation of the load balancing with failover and heartbeat-exposed health checks pattern
 as part of [Patterns for using floating IP addresses in Compute Engine](https://cloud.google.com/architecture/patterns-for-floating-ip-addresses-in-compute-engine#heartbeat-exposed) using [Terraform](https://www.terraform.io/).
